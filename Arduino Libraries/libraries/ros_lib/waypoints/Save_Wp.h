#ifndef _ROS_SERVICE_Save_Wp_h
#define _ROS_SERVICE_Save_Wp_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char SAVE_WP[] = "waypoints/Save_Wp";

  class Save_WpRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return SAVE_WP; };
    const char * getMD5(){ return "2415261c9605b9f38867ffbbe495fc04"; };

  };

  class Save_WpResponse : public ros::Msg
  {
    public:
