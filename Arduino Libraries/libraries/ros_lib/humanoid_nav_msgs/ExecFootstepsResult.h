#ifndef _ROS_humanoid_nav_msgs_ExecFootstepsResult_h
#define _ROS_humanoid_nav_msgs_ExecFootstepsResult_h
...
namespace humanoid_nav_msgs
{
  ...
  class ExecFootstepsResult : public ros::Msg
  {
    ...
    const char * getType(){ return "humanoid_nav_msgs/ExecFootstepsResult"; };
