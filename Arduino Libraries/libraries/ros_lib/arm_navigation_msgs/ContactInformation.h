#ifndef _ROS_arm_navigation_msgs_ContactInformation_h
#define _ROS_arm_navigation_msgs_ContactInformation_h
...
namespace arm_navigation_msgs
{
  ...
  class ContactInformation : public ros::Msg
  {
    public:
      ...
      typedef const char* _attached_body_1_type;
      _attached_body_1_type attached_body_1;
      ...
      typedef const char* _attached_body_2_type;
      _attached_body_2_type attached_body_2;
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 7) = (u_depth.base >> (8 * 7)) & 0xFF;
      ...
      uint32_t length_attached_body_1 = strlen(this->attached_body_1);
      varToArr(outbuffer + offset, length_attached_body_1);
      offset += 4;
      memcpy(outbuffer + offset, this->attached_body_1, length_attached_body_1);
      offset += length_attached_body_1;
      ...
      *(outbuffer + offset + 3) = (this->body_type_1 >> (8 * 3)) & 0xFF;
      ...
      uint32_t length_attached_body_2 = strlen(this->attached_body_2);
      varToArr(outbuffer + offset, length_attached_body_2);
      offset += 4;
      memcpy(outbuffer + offset, this->attached_body_2, length_attached_body_2);
      offset += length_attached_body_2;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      offset += length_contact_body_1;
      uint32_t length_attached_body_1;
      arrToVar(length_attached_body_1, (inbuffer + offset));
      offset += 4;
      for(unsigned int k= offset; k< offset+length_attached_body_1; ++k){
          inbuffer[k-1]=inbuffer[k];
      }
      inbuffer[offset+length_attached_body_1-1]=0;
      this->attached_body_1 = (char *)(inbuffer + offset-1);
      offset += length_attached_body_1;
      ...
      offset += length_contact_body_2;
      uint32_t length_attached_body_2;
      arrToVar(length_attached_body_2, (inbuffer + offset));
      offset += 4;
      for(unsigned int k= offset; k< offset+length_attached_body_2; ++k){
          inbuffer[k-1]=inbuffer[k];
      }
      inbuffer[offset+length_attached_body_2-1]=0;
      this->attached_body_2 = (char *)(inbuffer + offset-1);
      offset += length_attached_body_2;
    ...
    const char * getType(){ return "arm_navigation_msgs/ContactInformation"; };
    const char * getMD5(){ return "85f341c0166ad4e68b4421391bbd2e15"; };
