#ifndef _ROS_arm_navigation_msgs_JointConstraint_h
#define _ROS_arm_navigation_msgs_JointConstraint_h
...
namespace arm_navigation_msgs
{
  ...
  class JointConstraint : public ros::Msg
  {
    ...
    const char * getType(){ return "arm_navigation_msgs/JointConstraint"; };
