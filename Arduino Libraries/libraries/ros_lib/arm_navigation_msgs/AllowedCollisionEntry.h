#ifndef _ROS_arm_navigation_msgs_AllowedCollisionEntry_h
#define _ROS_arm_navigation_msgs_AllowedCollisionEntry_h
...
namespace arm_navigation_msgs
{
  ...
  class AllowedCollisionEntry : public ros::Msg
  {
    ...
    const char * getType(){ return "arm_navigation_msgs/AllowedCollisionEntry"; };
