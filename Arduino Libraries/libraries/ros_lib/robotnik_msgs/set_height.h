#ifndef _ROS_SERVICE_set_height_h
#define _ROS_SERVICE_set_height_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char SET_HEIGHT[] = "robotnik_msgs/set_height";

  class set_heightRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return SET_HEIGHT; };
    const char * getMD5(){ return "384d8dd5cbcb4f6e145e6b246fa635b2"; };

  };

  class set_heightResponse : public ros::Msg
  {
    public:
