#ifndef _ROS_robotnik_msgs_Axis_h
#define _ROS_robotnik_msgs_Axis_h
...
namespace robotnik_msgs
{
  ...
  class Axis : public ros::Msg
  {
    ...
    const char * getType(){ return "robotnik_msgs/Axis"; };
    const char * getMD5(){ return "e5a99fe291a5635d3f85f17b629d8088"; };
