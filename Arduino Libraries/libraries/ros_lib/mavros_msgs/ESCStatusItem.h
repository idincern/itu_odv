#ifndef _ROS_mavros_msgs_ESCStatusItem_h
#define _ROS_mavros_msgs_ESCStatusItem_h
...
namespace mavros_msgs
{
  ...
  class ESCStatusItem : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "mavros_msgs/ESCStatusItem"; };
    const char * getMD5(){ return "70651ef564857ec47d6e23206e2f7145"; };
